...
module.exports = {
    ...
    CHANNEL_LINK:          process.env.CHANNEL_LINK || "https://whatsapp.com/channel/0029VbCKsZSFcow7ucYvJc0J",
    CHANNEL_NAME:          process.env.CHANNEL_NAME || "MUMU MINI BOT",
    USE_PAIR_CODE:         toBool(process.env.USE_PAIR_CODE, true),
